...
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:4f2ac84440db11cee3d71d1cf01dab77";
...
const BOT_INFO = process.env.BOT_INFO || "X-BOT-MD;ASWIN SPARKY;https://i.imgur.com/bZUQlHI.jpeg";
const URL = process.env.URL || "https://www.instagram.com/kamran_.hasil";
const AUDIO_DATA = process.env.AUDIO_DATA || "X BOT MD;ASWIN SPARKY;https://i.imgur.com/bZUQlHI.jpeg";
