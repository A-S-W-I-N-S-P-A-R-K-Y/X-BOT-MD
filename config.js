...
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:fae934402a1c5cedcd96f0d5cc147726";
const SUDO = process.env.SUDO || '2349031429006';
...
const BOT_INFO = process.env.BOT_INFO || "Draken-MD;ASWIN SPARKY;https://i.imgur.com/r3GZeiX.jpeg";
...
const STICKER_DATA = process.env.STICKER_DATA || "Draken BOT MD;ASWIN SPARKY";
