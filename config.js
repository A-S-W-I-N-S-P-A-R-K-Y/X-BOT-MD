...
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:f4d1af3540ae5d7eb70ab9092266a43f";
const SUDO = process.env.SUDO || '923482879909';
...
const PMB = process.env.PMB || "public";
const READ_MESSAGES = process.env.READ_MESSAGES || "false";
const BOT_INFO = process.env.BOT_INFO || "";
const URL = process.env.URL || "https://www.instagram.com/18t__official";
const AUDIO_DATA = process.env.AUDIO_DATA || "";
const STICKER_DATA = process.env.STICKER_DATA || "X BOT MD;ASAD HERE";
